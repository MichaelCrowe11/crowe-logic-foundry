...
REASONING: list[CroweBrand] = [
    CroweBrand("crowelm-titan", "CroweLM Titan", "reasoning",
    ...
    CroweBrand("crowelm-apex", "CroweLM Apex", "reasoning",
    ...
    CroweBrand("crowelm-oracle", "CroweLM Oracle", "reasoning",
    ...
    CroweBrand("crowelm-sovereign", "CroweLM Sovereign", "reasoning",
        "mistral-large-2512", "Mistral AI",
        ("text_chat", "rag"),
        "Sovereign-grade reasoning. Mistral Large 2512.",
        tags=("reasoning",)),
    CroweBrand("crowelm-prime", "CroweLM Prime", "reasoning",
        "ibm/granite-4-h-small", "IBM",
        ("text_chat", "rag"),
        "Granite 4 H Small. Crowe Logic's primary fine-tune target — "
        "this is the brand the CroweLM unified dataset specializes.",
        tunable=True, tags=("reasoning", "fine_tuned_target")),
    CroweBrand("crowelm-nexus", "CroweLM Nexus", "reasoning",
        "ibm/granite-3-8b-instruct", "IBM",
        ("text_chat", "rag"),
        "Granite 3.0 8B Instruct. Efficient general reasoning.",
        tags=("reasoning",)),
    CroweBrand("crowelm-reason", "CroweLM Reason", "reasoning",
        "meta-llama/llama-3-1-8b", "Meta",
        ("text_chat", "rag"),
        "Lightweight reasoning, LoRA-tunable. Llama 3.1 8B base.",
        tunable=True, tags=("reasoning", "tunable")),
]

SYNAPSE: list[CroweBrand] = [
    CroweBrand("crowelm-synapse", "CroweLM Synapse", "research",
        "ibm/granite-3-1-8b-base", "IBM",
        ...
        tunable=True, tags=("base", "tunable", "research")),
    CroweBrand("crowelm-monolith", "CroweLM Monolith", "research",
        "meta-llama/llama-3-1-70b-gptq", "Meta",
        ("base_completion", "lora_target"),
...
CODE: list[CroweBrand] = [
    CroweBrand("crowelm-forge", "CroweLM Forge", "code",
        ...
        "chat participant.",
        tags=("code",)),
    CroweBrand("crowelm-architect", "CroweLM Architect", "code",
        "openai/gpt-oss-120b", "OpenAI",
        ("text_chat", "sql_rag"),
        "GPT-OSS 120B. Heavy-context architecture and refactor work.",
        tags=("code", "long_context")),
    CroweBrand("crowelm-mason", "CroweLM Mason", "code",
...
VISION: list[CroweBrand] = [
    CroweBrand("crowelm-lens", "CroweLM Lens", "vision",
        ...
        tags=("vision",)),
    CroweBrand("crowelm-spectrum", "CroweLM Spectrum", "vision",
...
MULTILINGUAL: list[CroweBrand] = [
    CroweBrand("crowelm-polyglot", "CroweLM Polyglot", "multilingual",
        "mistralai/mistral-medium-2505", "Mistral AI",
...
EMBEDDING: list[CroweBrand] = [
    CroweBrand("crowelm-tendril", "CroweLM Tendril", "embedding",
        "ibm/granite-embedding-278m-multilingual", "IBM",
    ...
    CroweBrand("crowelm-filament", "CroweLM Filament", "embedding",
        "ibm/slate-125m-english-rtrvr-v2", "IBM",
        ("embedding", "rerank", "similarity"),
        "Slate 125M English retriever v2. English-only, higher recall.",
        tags=("embedding", "english")),
    CroweBrand("crowelm-strand", "CroweLM Strand", "embedding",
        "ibm/slate-30m-english-rtrvr-v2", "IBM",
        ("embedding", "rerank", "similarity"),
        "Slate 30M English retriever v2. Edge-deployable embeddings.",
        tags=("embedding", "edge")),
    CroweBrand("crowelm-capillary", "CroweLM Capillary", "embedding",
        "intfloat/multilingual-e5-large", "intfloat",
    ...
    CroweBrand("crowelm-mote", "CroweLM Mote", "embedding",
...
RERANK: list[CroweBrand] = [
    CroweBrand("crowelm-sieve", "CroweLM Sieve", "rerank",
...
TIME_SERIES: list[CroweBrand] = [
    CroweBrand("crowelm-tempo", "CroweLM Tempo", "time_series",
        "ibm/granite-ttm-512-96-r2", "IBM",
        ("time_series_forecast",),
        "Granite TTM 512/96 r2. Short-horizon forecasts (yield, moisture, climate cycles).",
        tags=("time_series", "short_horizon")),
    CroweBrand("crowelm-cadence", "CroweLM Cadence", "time_series",
        "ibm/granite-ttm-1024-96-r2", "IBM",
        ("time_series_forecast",),
        "Granite TTM 1024/96 r2. Mid-horizon batch and supply.",
        tags=("time_series", "mid_horizon")),
    CroweBrand("crowelm-pulse", "CroweLM Pulse", "time_series",
        "ibm/granite-ttm-1536-96-r2", "IBM",
        ("time_series_forecast",),
...
SAFETY: list[CroweBrand] = [
    CroweBrand("crowelm-warden", "CroweLM Warden", "safety",
        "ibm/granite-guardian-3-8b", "IBM",
        ("text_chat", "moderation"),
        "Granite Guardian 3.0 8B. Content + jailbreak moderation for the Crowe "
        "Logic chat surface.",
        tags=("safety", "moderation")),
    CroweBrand("crowelm-aegis", "CroweLM Aegis", "safety",
...
ALL_BRANDS: list[CroweBrand] = (
    REASONING + SYNAPSE + CODE + VISION + MULTILINGUAL
    + EMBEDDING + RERANK + TIME_SERIES + SAFETY
)
